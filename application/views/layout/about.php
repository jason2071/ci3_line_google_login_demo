	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xl-8 col-lg-12">
				<p class="mb-5"><img src="<?php echo base_url()."/assets/aside/images/img_bg_2.jpg" ?>" alt="Free Bootstrap 4 Template by uicookies.com" class="img-fluid"></p>
				...
				<div class="row">
					<div class="col-xl-8 col-lg-12 mx-auto">
						...
						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One
							day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
				...
				<div class="row mb-5">
					<div class="col-md-12">
						<div class="owl-carousel probootstrap-owl">
							<div class="item">
								<img src="<?php echo base_url()."/assets/aside/images/person_1.jpg" ?>" class="img-fluid" alt="Free Template by uicookies.com">
							...
							<div class="item">
								<img src="<?php echo base_url()."/assets/aside/images/person_2.jpg" ?>" class="img-fluid" alt="Free Template by uicookies.com">
								<div class="p-4 border border-top-0">
									<h4>Craig Smith</h4>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
										blind texts.</p>
							...
							<div class="item">
								<img src="<?php echo base_url()."/assets/aside/images/person_3.jpg" ?>" class="img-fluid" alt="Free Template by uicookies.com">
								<div class="p-4 border border-top-0">
									<h4>Peter Wood</h4>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
										blind texts.</p>
